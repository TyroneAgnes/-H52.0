              ...
              <CardContent className="p-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-medium">¥{(mentor.investAmount / 10000).toFixed(0)}万</div>
                  </div>
                  <div>
            ...
            <Card className="border-0 shadow-sm bg-white">
              <CardContent className="p-4">
                ...
                <div className="grid grid-cols-4 gap-3">
                  ...
                  <div className="text-center">
                    <div
                      className={`text-lg font-semibold ${mentor.performance.yearly >= 0 ? "text-green-600" : "text-red-600"}`}
                    >
                      {mentor.performance.yearly >= 0 ? "+" : ""}
                      {mentor.performance.yearly}%
                    </div>
